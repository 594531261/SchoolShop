...
public abstract class ImageWorker {
	...
	public void loadImage(Object data, ImageView imageView) {
		imageView.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.default_img));
		Bitmap bitmap = null;
		if (mImageCache != null) {
...
//				imageView.setScaleType(ScaleType.FIT_XY);
				...
				int hh = Myapp.columnWidth*height/width;
//				
//				LinearLayout.LayoutParams mParams = new LinearLayout.LayoutParams(
//						Myapp.columnWidth,
//						hh);
//				imageView.setLayoutParams(mParams);
				Bitmap bitmap1 = zoomImage(bitmap,Myapp.columnWidth,hh);
				bit = getRoundedCornerBitmap(bitmap1);
...
//		System.out.println("9999911111111111111111111111111111111111");
		// 获取这个图片的宽和高
		...
		Bitmap bitmap1 = Bitmap.createBitmap(bgimage, 0, 0, (int) width, (int) height,
				matrix, true);
