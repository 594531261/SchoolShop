...
public class MultiColumnListView extends PLA_ListView {
    ...
    private int mColumnPaddingLeft = 5;
    private int mColumnPaddingRight = 5;
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            mColumnPaddingLeft = a.getDimensionPixelSize(R.styleable.PinterestLikeAdapterView_plaColumnPaddingLeft, 5);
            mColumnPaddingRight = a.getDimensionPixelSize(R.styleable.PinterestLikeAdapterView_plaColumnPaddingRight, 5);
            a.recycle();
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        columnWidth = (getMeasuredWidth() - mListPadding.left - mListPadding.right - mColumnPaddingLeft - mColumnPaddingRight)
                / getColumnNumber()-5;
        Myapp.columnWidth = columnWidth;
        for (int index = 0; index < getColumnNumber(); ++index) {
            mColumns[index].mColumnWidth = columnWidth;
            mColumns[index].mColumnLeft = mListPadding.left + mColumnPaddingLeft+10*index + columnWidth * index;
        }
