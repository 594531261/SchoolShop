...
//		RelativeLayout.LayoutParams params1 = new RelativeLayout.LayoutParams(width/2, LayoutParams.WRAP_CONTENT);
//		params1.leftMargin=Util.leftpad;;
...
//		RelativeLayout.LayoutParams params1 = new RelativeLayout.LayoutParams(switcherViewWidth/4, LayoutParams.WRAP_CONTENT);
//		dotsLayout.setLayoutParams(params1);
		refreshDotsLayout();
	}
	...
	private void refreshDotsLayout() {
		...
		/*for (int i = 0; i < itemsCount; i++) {
			...
			if (i == currentItemIndex) {
				image.setBackgroundResource(R.drawable.add_to_car_button_normal);
			} else {
				image.setBackgroundResource(R.drawable.add_to_car_button_disabled);
			}
			
			
			
			RelativeLayout.LayoutParams relativeParams = new RelativeLayout.LayoutParams(
					switcherViewWidth/4, 10);
		...
		for (int i = 0; i < itemsCount; i++) {
			LinearLayout.LayoutParams linearParams = new LinearLayout.LayoutParams(100,
